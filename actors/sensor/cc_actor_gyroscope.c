...
static void cc_actor_gyroscope_free(cc_actor_t *actor)
{
	cc_state_t *state = NULL;
...
static cc_result_t cc_actor_gyroscope_get_attributes(cc_actor_t *actor, cc_list_t **managed_attributes)
{
...
static cc_result_t cc_actor_gyroscope_get_requires(cc_actor_t *actor, cc_list_t **requires)
{
...
cc_result_t cc_actor_gyroscope_setup(cc_actor_type_t *type)
{
	...
	type->free_state = cc_actor_gyroscope_free;
	type->get_managed_attributes = cc_actor_gyroscope_get_attributes;
